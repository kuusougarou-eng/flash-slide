...
assert.strictEqual(listPrim.text.split("\v").length - 1, 2, "child rows sit on soft line breaks inside the parent paragraph");
assert.ok(listPrim.bullets && !/•/.test(listPrim.text), "native bullets for the top level, no pseudo bullet character");
